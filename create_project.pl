...
# $inteliform_perl_dir - location of inteliform_perl
...
my ($projeto_id, $inteliform_perl_dir) = @ARGV;

my $host = hostname; # Get local hostname
my %config; # Get configuration file
my %hosts = do "$inteliform_perl_dir/inteliform_perl/hosts.pl"; # Get configured hosts if any
my $prod;

unless (%hosts){
    %config = do "$inteliform_perl_dir/inteliform_perl/config.pl";    
}
else{
    foreach my $key (keys %hosts) {
        if ( $host eq $hosts{$key}->[0] ){
            %config = do "$inteliform_perl_dir/inteliform_perl/$hosts{$key}->[1]";    
...
# Sistema
my $sistema = Sistema->new("$projeto_id", $inteliform_perl_dir);
...
sub CopiaDefaultApps{
    ...
    system ("cp -r $inteliform_perl_dir/inteliform_perl/default_apps/* $temp_dir/$project_name/");
...
sub ConfigApache{
    ...
    sub Configura_VirtualHosts{
        ...
        sub Template_VirtualHosts{
            ...
            my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/virtualhosts";
...
sub EditaBase_html{
    ...
    sub Template_Base_html{
        ...
        my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/$html_file";
        my $template = Template->new(ABSOLUTE => 1,);
        $template->process($template_local, $vars, \$output)
            || die "Template process failed: ", $template->error(), "\n";
        return $output;
...
sub EditaSettings_py{
    ...
    sub Template_Settings_py{
        ...
        my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/settings.py";
        my $template = Template->new(ABSOLUTE => 1,);
        $template->process($template_local, $vars, \$output)
            || die "Template process failed: ", $template->error(), "\n";
        return $output;
...
sub EditaUrls_py{
    ...
    sub Template_Urls_py{
        ...
        my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/project_urls.py";
        my $template = Template->new(ABSOLUTE => 1,);
        $template->process($template_local, $vars, \$output)
            || die "Template process failed: ", $template->error(), "\n";
        return $output;
...
#=cut
    ...
    sub ConfiguraAppsArquivos{
        ...
        # Agora tem o mecanismo que popula os campos com os valores definidos pelo usuario no Inteliform.
        ...
        sub ConfiguraSqlFile{
            ...
            sub CriaSqlFile{
                ...
                my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/sql_file.sql";
                my $template = Template->new(ABSOLUTE => 1,);
                $template->process($template_local, $vars, \$output)
                    || die "Template process failed: ", $template->error(), "\n";
                return $output;
        ...
        sub Template_Apps_Urls_py{
            ...
            my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/apps_urls.py";
            my $template = Template->new(ABSOLUTE => 1,);
            $template->process($template_local, $vars, \$output)
                || die "Template process failed: ", $template->error(), "\n";
            return $output;
        ...
        sub Configura_Admin_py{
            ...
            sub Template_Admin_py{
                ...
                my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/admin.py";
                my $template = Template->new(ABSOLUTE => 1,);
                $template->process($template_local, $vars, \$output)
                    || die "Template process failed: ", $template->error(), "\n";
                return $output;
...
=cut                
        ...
        sub Configura_Views_py{
            ...
            sub Template_Views_py{
                ...
                my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/views.py";
                my $template = Template->new(ABSOLUTE => 1,);
                $template->process($template_local, $vars, \$output)
                    || die "Template process failed: ", $template->error(), "\n";
                return $output;
        ...
        sub Configura_Models_py{
            ...
            sub Template_Models_py{
                ...
                my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/models.py";
                my $template = Template->new(ABSOLUTE => 1,);
                $template->process($template_local, $vars, \$output)
                    || die "Template process failed: ", $template->error(), "\n";
                return $output;
...
sub CriaProjeto{
    ...
    system("cp $inteliform_perl_dir/inteliform_perl/templates/decorators.py $temp_dir/$project_name/$project_name/");
    ...
    sub Configura_WSGI_py{
        ...
        sub Template_WSGI_py{
            ...
            my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/wsgi.py";
            my $template = Template->new(ABSOLUTE => 1,);
            $template->process($template_local, $vars, \$output)
                || die "Template process failed: ", $template->error(), "\n";
            return $output;
...
sub Edita_tabela_django_site{
    ...
    sub Django_Site{
        ...
        my $template_local = "$inteliform_perl_dir/inteliform_perl/templates/site.json";
        my $template = Template->new(ABSOLUTE => 1,);
        $template->process($template_local, $vars, \$output)
            || die "Template process failed: ", $template->error(), "\n";
        return $output;
...
sub SetFakeData{
    ...
    foreach (@fake_yaml){
        system("cp $inteliform_perl_dir/inteliform_perl/templates/fake/$_ $dir_definitivo/$project_name/fixtures/");
