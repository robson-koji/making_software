...
class LoginView(RedirectAuthenticatedUserMixin, FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ret.update({"signup_url": signup_url,
                    ...
                    "interface_template": self.kwargs['interface_template'],
                    "my_account_login": self.kwargs['my_account_login']})
        return ret
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx['interface_template'] = self.kwargs['interface_template']
        ctx['my_account_confirm_email'] = self.kwargs['my_account_confirm_email']        
        return ctx

    def get_redirect_url(self):
        return reverse(self.kwargs['my_success_redirect'])
...
class EmailView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ret['interface_template'] = self.kwargs['interface_template']
        ret['my_account_email'] = self.kwargs['my_account_email']        
        # (end NOTE)
...
class PasswordChangeView(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        if not request.user.has_usable_password():
            ...
            return HttpResponseRedirect(reverse(self.kwargs['my_account_set_password']))
    ...
    def get_success_url(self):
        # Explicitly passed ?next= URL takes precedence
        #my_success_url = settings.URL_ROOT+self.kwargs['my_success_url']
        return reverse_lazy(self.kwargs['my_success_url'])
...
class LogoutView(TemplateResponseMixin, View):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx.update({
            ...
            "redirect_field_value": redirect_field_value,
            "interface_template": self.kwargs['interface_template'],
            "my_account_logout": self.kwargs['my_account_logout']}),
        return ctx
